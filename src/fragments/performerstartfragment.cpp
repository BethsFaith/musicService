...
void PerformerStartFragment::on_pb_myCatalog_clicked() {
    navigator->newRootScreen(screens::PERFTOOLS_TAG, nullptr, m_perf);
}

void PerformerStartFragment::on_pb_seacrh_clicked() {
    navigator->newRootScreen(screens::SEARCH_TAG, m_perf->getPerformer()->dataBase(), m_perf);
}

void PerformerStartFragment::on_pb_catalog_clicked() {
    navigator->newRootScreen(screens::CATALOG_TAG, m_perf->getPerformer()->dataBase(), m_perf);
}
